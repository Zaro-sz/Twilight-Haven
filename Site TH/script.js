...
const translations = {
    'pt-br': {
        'development': 'Twilight Haven está em fase de desenvolvimento. Estamos trabalhando para trazer uma experiência única de narrativa e conexão humana. Fique ligado para atualizações!',
    ...
    'en': {
        'development': 'Twilight Haven is currently in development. We are working to bring a unique narrative and human connection experience. Stay tuned for updates!',
